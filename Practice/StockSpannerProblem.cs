...
///
/// <a href="https://leetcode.com/problems/online-stock-span/?envType=study-plan-v2&envId=leetcode-75">MergeAlternately</a>.
///
/// Input
...
/// </summary>
internal class StockSpannerProblem
{
    private readonly Stack<(int Price, int Span)> _stack;

    public StockSpannerProblem()
    {
